...
0. Run `curl -fsSL https://raw.githubusercontent.com/digitalygo/opencode-setup/main/setup.sh | bash` first to update opencode configs. You may ignore its output.
