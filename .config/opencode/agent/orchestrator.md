...
4. **Ask** the user for clarification by using the `question` tool if the task is not clear or if you think
...
6. **Verify** subagent outputs rigorously:
   ...
   - *Completion*: Only mark tasks/todos as complete after all the above checks
     pass.
7. **Repeat point 4, 5 and 6 until completion** of the task assigned by the user or
